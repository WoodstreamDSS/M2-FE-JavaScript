(function($) {
  ...
  $('.home-tabs .tab-panel[aria-hidden="true"] a').attr('tabindex',-1);
  ...
  woodstream.z3 = function(id) {
    ...
    this.el.on('keyup', function(e) {
      if (e.which === 37) { if (!this.animating) { this.animating = true; this.left(); } }
      if (e.which === 39) { if (!this.animating) { this.animating = true; this.right(); } }
    }.bind(this));
  ...
  $(document).ready(function() {
    ...
    if ($('#ws-reviews').length > 0) {  var reviewSlider = new woodstream.z3('ws-reviews', true); };
    blockSliders.push(new woodstream.BlockSlider('article-slider'));
    blockSliders.push(new woodstream.BlockSlider('support-slider'));
    blockSliders.push(new woodstream.BlockSlider('instagram-slider'));
    blockSliders[1].hide();
    blockSliders[2].hide();
  });
