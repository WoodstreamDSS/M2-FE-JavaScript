...
require(['jquery'], function($) {
  ...
  $(document).ready(function() {
    ...
    if ($('#ws-reviews').length > 0) { var ppHomeZoom = new woodstream.z3('ws-reviews', true); }

    blockSliders.push(new woodstream.BlockSlider('article-slider'));
    blockSliders.push('');
    blockSliders.push(new woodstream.BlockSlider('tools-slider'));
    blockSliders[2].hide();
    ...
    var activateSlider = function() { // Create a block slider for the IG feed
      blockSliders[1] = new woodstream.BlockSlider('instagram-slider'); // Create an instance of the BlockSlider, for the Instagram feed
      blockSliders[1].hide();
