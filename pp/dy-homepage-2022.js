require(['jquery'], function ($) {
  ...
  let banners = $('dy-homepage-2022 .hero-banner>div');
  ...
  const reviewTitlesEH = new woodstream.VPEqualHeight(
    'dy-homepage-2022 .mb-reviews .review span.review-title',
    0
  );
  const reviewProductsEH = new woodstream.VPEqualHeight(
    'dy-homepage-2022 .mb-reviews .review span.review-product',
    0
  );
  const reviewTextEH = new woodstream.VPEqualHeight(
    'dy-homepage-2022 .mb-reviews .review .review-text',
    0
  );
