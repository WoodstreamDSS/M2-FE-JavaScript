...
require(['jquery'], function($) {
  ...
  $(document).ready(function() {
    ...
    if ($('#ws-reviews').length > 0) { var mmHomeZoom = new woodstream.z3('ws-reviews', true); }
    blockSliders.push(new woodstream.BlockSlider('article-slider'));
    blockSliders.push(new woodstream.BlockSlider('youtube-slider'));
    blockSliders.push(new woodstream.BlockSlider('support-slider'));
    blockSliders[1].hide();
    blockSliders[2].hide();
  });

  $('#youtube-slider .article-title').on('click', function(e) {
    $(this).prev('.youtube-player').find('div[tabindex="0"]').click();
  });
